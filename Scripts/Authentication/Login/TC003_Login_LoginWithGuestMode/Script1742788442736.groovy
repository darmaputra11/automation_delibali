...
//Click Sign In with Guest
Mobile.tap(LoginObject.signinButton, 0)

//Verify Already on Homepage
Mobile.verifyElementExist(findTestObject('Object Repository/Homepage/Homepage_Title_Category'), 0)
